"""
 Директория содержит файлы, относящиеся к логике переноса комментариев к задачам.
 Для успешной миграции комментарии к задачам необходимо, предварительно перенести задачи.
 Скрипт запуска миграции находится в comments_migration.py
"""
